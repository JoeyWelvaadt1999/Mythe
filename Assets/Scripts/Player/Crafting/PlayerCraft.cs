...
public class PlayerCraft : MonoBehaviour
{
	...
	private Resources _recourses;//Empty variable, will be used to store Recourses from te PlayerInventory component
	...
	void Start ()
    {
		...
		_recourses = _playerInventory.PlayerResources;//Put the recources from the PlayerInventory component in the recourses variable in this component
